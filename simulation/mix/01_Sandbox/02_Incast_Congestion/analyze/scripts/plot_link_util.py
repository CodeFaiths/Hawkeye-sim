...
def main() -> None:
    ...
    parser.add_argument("--topology", type=Path, default=base_dir / "config" / "topology_h2_s3.txt", help="Topology file that lists the switch node IDs on the second line.")
